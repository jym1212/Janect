...
public class CertDatasetFineTuneGemma {

    private MultiLayerNetwork model;
    private DataSetIterator trainData;

    public CertDatasetFineTuneGemma(String modelName, String datasetName, int numLabels) {
    ...
    public static void main(String[] args) {
        CertDatasetFineTuneGemma fineTuner = new CertDatasetFineTuneGemma("bert-base-uncased", "glue", 2);
