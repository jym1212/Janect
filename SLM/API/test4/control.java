...
public class control {
    ...
    public static void main(String[] args) {
        // This XML data could be fetched from an API or file instead
        String xmlData = getXmlDataFromAPI(); // Assume this method fetches XML from an external source
        ...
        try {
            ...
            System.out.println("Total items: " + nodeList.getLength());
            for (int i = 0; i < nodeList.getLength(); i++) {
                processItem(nodeList.item(i));
            }
    ...
    private static void processItem(Node node) {
    ...
    private static String getXmlDataFromAPI() {
        // Implement API call and return XML data as a string
        return "<response><header><resultCode>00</resultCode><resultMsg>NORMAL SERVICE</resultMsg></header><body>...</body></response>";
    }
}